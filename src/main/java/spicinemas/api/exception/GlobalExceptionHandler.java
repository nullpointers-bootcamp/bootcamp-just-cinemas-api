...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> notFoundException(final ScreenNotFoundException e) {
        return error(e, HttpStatus.NOT_FOUND, e.getMessage());
    }

    private ResponseEntity<Error> error(final Exception exception, final HttpStatus httpStatus, final String logRef) {
